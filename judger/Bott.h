...
class Bott
{
    public:
         ...
         */
        int Getcha_id() { return cha_id; }
        /** Set cha_id
         * \param val New value to set
         */
        void Setcha_id(int val) { cha_id = val; }
        /** Access src
         ...
         */
        int Getnumber_of_testcases() { return number_of_testcases; }
        /** Set number_of_testcases
         * \param val New value to set
         */
        void Setnumber_of_testcases(int val) { number_of_testcases = val; }
        /** Access time_limit
         * \return The current value of time_limit
         */
        int Gettime_limit() { return time_limit; }
        /** Set time_limit
         * \param val New value to set
         */
        void Settime_limit(int val) { time_limit = val; }
        /** Access case_limit
         * \return The current value of case_limit
         */
        int Getcase_limit() { return case_limit; }
        /** Set case_limit
         * \param val New value to set
         */
        void Setcase_limit(int val) { case_limit = val; }
        /** Access memory_limit
         ...
         */
        int Getspj() { return spj; }
        /** Set spj
         * \param val New value to set
         */
        void Setspj(int val) { spj = val; }
        /** Access vname
         ...
         */
        int Getdata_type() { return data_type; }
        /** Set data_type
         * \param val New value to set
         */
        void Setdata_type(int val) { data_type = val; }
        /** Access data_detail
         ...
         * \return The current value of data_detail
         */
        int Getdata_lang() { return data_lang; }
        /** Set data_lang
         * \param val New value to set
         */
        void Setdata_lang(int val) { data_lang = val; }
        /** Access cha_result
