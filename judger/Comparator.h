...
class Comparator
{
    public:
        Comparator();
        virtual ~Comparator();
        string Getstdout_filename() { return stdout_filename; }
        void Setstdout_filename(string val) { stdout_filename = val; }
        ...
        int Getisspj() { return isspj; }
        void Setisspj(int val) { isspj = val; }
        Program * Getspj() { return spj; }
        void Setspj(Program * val) { spj = val; }
        string Getdetail() { return detail; }
        void Setdetail(string val) { detail = val; }
        int Compare();
